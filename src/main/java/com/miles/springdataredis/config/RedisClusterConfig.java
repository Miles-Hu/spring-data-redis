...
public class RedisClusterConfig {
    ...
    public RedisClusterConfiguration getClusterConfig() {
        ...
        rcc.setMaxRedirects(Integer.parseInt(clusterProperties.getMaxRedirects()));
        return rcc;
    }
    ...
    @Bean
    public StringRedisTemplate getStringRedisTemplate(@Qualifier("jedisConnectionFactory") RedisConnectionFactory factory) {
